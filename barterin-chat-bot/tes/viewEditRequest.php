    ...
    <div class="container" style="padding-top: 50px; padding-bottom: 70px;">
        <section id="contact">
            <div class="my-5 row text-center">
                <h1>Tambah Data Request</h1>
            </div>
            <p><a href="viewRequest.php">Back</a></p>
            <form method="post" class="form-tambah" id="formEdit">
                <table class="table">
                    <?php
                    include('conn.php');
                    $id = isset($_GET['id']) ? (int) $_GET['id'] : 0;
                    $sql = 'select * from list_request where id=' . $id;
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" autocomplete="off" size="50" type="text" name="queries" value="<?= $row['queries'] ?>" required></td>
                    </tr>
                    <tr>
                        <td>Jawaban</td>
                        <td>:</td>
