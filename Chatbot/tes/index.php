...
<body style="height: 100vh; background-color: #fff;">
    ...
    <div class="container" style="padding-top: 50px; padding-bottom: 70px;">
        <section id="contact">
            ...
            <p><a href="viewTambah.php">Add New</a></p>
            <div class="col-md-12">
                <div class="row">
                    ...
                    <table class="table table-bordered" id="data">
                        ...
                        <tbody>
                            ...
                            include 'conn.php';
                            $no = 1;
                            $query = "SELECT * FROM list_queries ORDER BY id DESC";
                            ...
                            while ($row = $res1->fetch_assoc()) {
                                $id = $row['id'];
                                $queries = $row['queries'];
                                nl2br(htmlspecialchars($replies = $row['replies']));
                            ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    ...
                                    <a href=" viewEdit.php?id=<?= $id ?>">[Edit]</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
