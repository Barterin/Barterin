...
<div class="container mt-5">
    ...
    <form id="formEditBarang">
        ...
        <input type="hidden" value="" id="idItems">
        <!-- <div class="col-3 text-center mt-4">
            <img src="../Asset/profile.png" class="mb-3" style="width: 100%; border-radius: 5px;" alt="">
            <div class="input-group mb-3">
                <input type="file" class="form-control" id="inputGroupFile01" name="photo[]" accept="image/*" multiple>
            </div>
        </div> -->
        <div class="col-9">
...
<loadjs-editBarang></loadjs-editBarang>
