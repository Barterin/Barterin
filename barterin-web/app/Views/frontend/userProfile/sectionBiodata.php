<div class="col">
    <div class="row">
        <div class="col-1" id="profile-picture-preview">
            <img src="../../assets/image/profile.png" alt="" class="rounded-circle profile-picture" id="picture" />
        </div>
        <form class="mt-3" id="profilePic">
            <label for="formFile" class="form-label fw-bold">Upload Foto Profile</label>
            <input type="file" class="form-control" id="pictureInput" name="photo" accept="image/*">
